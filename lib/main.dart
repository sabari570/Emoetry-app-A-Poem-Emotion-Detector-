...
import 'package:emo_etry_app/screens/splashScreen/splashScreen.dart';
...
void main() async {
  ...
  // set the preferred orientation(s)
  SystemChrome.setPreferredOrientations([
    DeviceOrientation.portraitUp, // set portrait orientation
    DeviceOrientation.portraitDown, // set portrait orientation
  ]);
  runApp(const MyApp());
}
